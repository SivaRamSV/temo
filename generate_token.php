...
if(isset($name) && !empty($name))
{
	if( $extension == $size<=$max_size)
	{
		...
		{
			$query = "INSERT INTO `upload` (name, size, type, location, user, token,usertoken,UTime,Etime,hash) VALUES ('$name', '$size', '$type', '$location$name', '$user', '$tval','$tvaluser','$date','$time','$hash')";
